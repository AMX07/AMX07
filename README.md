...
I work on language model research, with a focus on:

- Optimizing pre-training runs for language models
- Stress-testing LLMs through evals to expose current limitations
- Researching ways to improve weak areas in LLMs, including game-playing, memory, and continual learning

## Highlighted Projects

| Project | What it does |
|--------|--------------|
| [Deep Learning Experiments](https://github.com/AMX07/research) | My implementations and experiments, ranging from Karpathy’s Micrograd to Transformer architectures |
